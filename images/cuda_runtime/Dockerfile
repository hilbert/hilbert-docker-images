# Taken from https://gitlab.com/nvidia/cuda/blob/ubuntu14.04/7.5/runtime/Dockerfile
...
ARG DOCKERFILE="/images/cuda_runtime/Dockerfile"
LABEL org.label-schema.description="Base for OpenGL+CUDA applications" \
