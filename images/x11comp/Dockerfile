...
MAINTAINER Oleksandr Motsak <malex984+hilbert.x11comp@gmail.com>

RUN update.sh && install.sh xcompmgr compton && clean.sh
...
ARG DOCKERFILE="/images/x11comp/Dockerfile"
LABEL org.label-schema.description="composing window manager (xcompmgr or compton) as a service" \
