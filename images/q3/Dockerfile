...
MAINTAINER Oleksandr Motsak <malex984+hilbert.q3@gmail.com>
...
ARG DOCKERFILE="/images/q3/Dockerfile"
LABEL org.label-schema.description="image with OpenArena for testing CPU performance" \
